...
module.exports = {
  data: {
    name: Settings.Commands.PREFIX_DEFAULT_COMMAND + Settings.Commands.Shortcut.search.wiktionary,
  },
  execute: async (interaction) => {
    ...
    if (interaction.type == Settings.Components.DEFAULT_MESSAGE_TYPE) {
      ...
      const args = message.content
                  .slice(Settings.Commands.PREFIX_DEFAULT_COMMAND.length + Settings.Commands.Shortcut.search.wiktionary.length)
                  .trim();
      if ( !args || args == "" ) {
      ...
      search_engine = Settings.Search_Engines.Names.Wiktionary;
      url = Settings.Search_Engines.Urls.Wiktionary + search_term;
      // server reply
