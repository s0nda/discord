...
module.exports = {
  ...
  execute: async (message) => {
    ...
    //
    // The commands are stored in array-like collection "client.commands" (see "bot.js").
    // With "message.client.commands" we can access them. Each of those commands (cmd)
    // has is an array containing ShlasCommand structure. See "q-ping" in the following
    // example:
    // 
    // cmd = 
    //    [
